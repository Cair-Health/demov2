...
const Home = () => {
  ...
  const startChat = async () => {
    try {
      ...
      const response = await fetch("https://54.204.80.122:5000/start_chat/", requestOptions);
      if (!response.ok) {
  ...
  const handlePaperPlaneClick = async () => {
    ...
    try {
      ...
      const getResponseResponse = await fetch("https://54.204.80.122:5000/get_response/", getResponseOptions);
